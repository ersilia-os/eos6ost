...
- **Interpretation:** Up to 1000 molecules generated by decorating the inputs Murcko scaffold with new R-groups; the inputs own substituents are discarded, so outputs are not generally similar to the query.
